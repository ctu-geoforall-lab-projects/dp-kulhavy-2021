...
%% ML: piste python s velkym pismenem (sladit v celem textu)
...
%% ML: v textu zbytecne anglikanismy 
...
%% ML: navic nejde o "update", ale o verzi
...
%% ML: prikazy byste mel pro lepsi citelnost formatovat jinak (napr. \tt}
...
%% ML: hodnoceni jako napr. "nejlepsi" do textu prace prilis nepatri...
%% ML: Django piste s velkym pismenem
...
proměnné atd
%% ML: pouzijte jednotne formatovani, napr. tridu v tomto odstavci
%% nemate vubec neformatovanu...
...
%% ML: zadokrovani maximalne v uvozovkach a vysvetlit
...
%% ML: anglikanismus, navic nevysvetleny
...
%% ML: piste docker s velkym pismenem
