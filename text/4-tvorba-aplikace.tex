...
%% ML: Vetu "import path" zkuste prepsat.
...
%% ML: pridejte odkaz na diagram db struktury
...
%% ML: v textu pouzivate nekonzistentni formatovani, nekde jsou nazvy
%% souboru bez formatovani, jinde kurzivou a pod.
...
%% ML: Nepouzivejte anglictinu v nazvu kapitoly
...
%% ML: ostatni tabulky jsou malymi pismeny, cvut, cvut_files, dale v
%% textu jiz mate nazev takulky malymi pismeny, sjednotte to (i z
%% pohledu formatovani)
...
%% ML: Nove? Vyberova databaze vznika z centralni databaze
...
%% ML: upravit nazev kapitoly, jinak lze na kapitoly odkazovat
%% hyperlinkem (\label{} + \ref{}), podobne jako na obrazky
...
%% opet sjednotit, CvutFiles vs. base_images
...
%% ML: v textu pouzivate doslovny preklad "superuzivate", lepsi by
%% bylo mozna "administratora", ale to uz nechte
